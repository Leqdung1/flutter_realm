...
class Car extends _Car with RealmEntity, RealmObjectBase, RealmObject {
  ...
  Car(String make, {String? model, int? kilometer = 500, Person? owner}) {
    if (!_defaultsSet) {
      _defaultsSet = RealmObjectBase.setDefaults<Car>({'kilometer': 500});
    }
    RealmObjectBase.set(this, 'make', make);
    RealmObjectBase.set(this, 'model', model);
    RealmObjectBase.set(this, 'kilometer', kilometer);
  ...
  @override
  int? get kilometer => RealmObjectBase.get<int>(this, 'kilometer') as int?;
  @override
  set kilometer(int? value) => RealmObjectBase.set(this, 'kilometer', value);
  ...
  static Car _fromEJson(EJsonValue ejson) {
    ...
    return switch (ejson) {
      {'make': EJsonValue make} => Car(
        ...
        kilometer: fromEJson(ejson['kilometer'], defaultValue: 500),
  ...
  static final schema = () {
    ...
    return const SchemaObject(ObjectType.realmObject, Car, 'Car', [
      ...
      SchemaProperty('kilometer', RealmPropertyType.int, optional: true),
      SchemaProperty(
        'owner',
